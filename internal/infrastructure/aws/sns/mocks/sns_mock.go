...
// Source: internal/infrastructure/aws/sns/sns_interface.go
//
// Generated by this command:
//
//	mockgen -source=internal/infrastructure/aws/sns/sns_interface.go -destination=internal/infrastructure/aws/sns/mocks/sns_mock.go
//
...
func (m *MockSNSInterface) Publish(ctx context.Context, message string) error {
	m.ctrl.T.Helper()
...
func (mr *MockSNSInterfaceMockRecorder) Publish(ctx, message any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Publish", reflect.TypeOf((*MockSNSInterface)(nil).Publish), ctx, message)
}
